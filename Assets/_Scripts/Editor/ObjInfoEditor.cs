...
public class ObjInfoEditor : OdinMenuEditorWindow
{
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        tree.AddAllAssetsAtPath("Enemy Info", "Assets/_Prefabs/Objectives/_InfoSOs/", typeof(EnemyInfoSO));
        return tree;
    }
    ...
    public class CreateNewEnemyData
    {
        ...
        {
            AssetDatabase.CreateAsset(enemyData, "Assets/_Prefabs/Objectives/_InfoSOs/" + enemyData.Name + ".asset");
